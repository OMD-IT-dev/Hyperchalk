...
@collab_router.get("/{room_name}/file/{file_id}.json", response=ExcalidrawBinaryFile, url_name="get_file")
...
@require_room_access(json=True)
async def put_file(request: HttpRequest, room_name: str, file_id: str, content: ExcalidrawBinaryFile):
