...
class OneOffRegistrationLink(models.Model):
    ...
    consumer_registration_timestamp = models.DateTimeField(_("consumer registration timestamp"), null=True, blank=True)
...
class CustomUser(AbstractUser):
    ...
    id = models.UUIDField(primary_key=True, default=uuid.uuid4, editable=False)
    registered_via = models.ForeignKey(LtiTool, on_delete=models.CASCADE, null=True, verbose_name=_("registered via"))
